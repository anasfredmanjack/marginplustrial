...
export default function AfricaFuture() {
  return (
    <section className="p-8 mt-[100px] bg-[#67D99D] relative">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-3xl mx-auto py-16">
          <h2 className=" md:text-6xl text-5xl font-extrabold text-white mb-6">You are investing in Africa&apos;s Future!</h2>
          <p className="text-black mb-8 lg:w-[500px] md:text-2xl  font-semibold  mx-auto">
